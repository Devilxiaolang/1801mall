					...
					<c:forEach items="${res.data}" var="emp">
						<tr>
							...
							<td>
								...
								<a
								href="${pageContext.request.contextPath}/empAction/emp/update/${emp.empno}">update</a></td>
						</tr>
					</c:forEach>
				</table>
				<center>
					<ul class="pagination">
						<%--使用路由跳转到其他页面--%>
						<li><a
							href="${pageContext.request.contextPath}/router/save">creat
								new emp</a></li>
						<li><a href="${pageContext.request.contextPath}/ReportServlet">get report</a></li>
					</ul>
				</center>
				<form
						action="${pageContext.request.contextPath}/empAction/empfbn"
						method="post">
...
<script type="text/javascript">
    ...
    $(function () {
		$("#findbyid").click(function () {
		    //点击后window.location.href 直接跳转到action
            window.location.href = "http://localhost:8080/login/empAction/emp/findbyid/"+$("#empno").val();
        })
    })
</script>
</body>
